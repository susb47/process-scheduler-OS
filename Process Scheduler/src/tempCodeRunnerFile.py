...
class SchedulerGUI:
    ...
    def create_widgets(self):
        ...
        style.configure("TCombobox", padding=5, foreground="black")
        ...
        self.algorithm_combo = ttk.Combobox(self.algorithm_frame, values=["FCFS", "Round Robin", "SJF", "Priority"], textvariable=self.selected_algorithm)
